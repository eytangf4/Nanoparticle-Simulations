...
def save_data_to_file(temperature, d, elevation1, elevation2, analysis_type, arr_1, arr_2):
    ...
    simulation_folder = f"simulation_analysis/feo/Temperature{temperature}_distance{d}_azimuth1_0pi_elevation1_{to_fraction(elevation1)}pi_azimuth2_0pi_elevation2_{to_fraction(elevation2)}pi"
...
def save_analyses():
    for elevation1,elevation2 in [(0,0), (0,math.pi/2), (math.pi/2,math.pi/2)]:
        for temp in range (300,1400,100):
            for d in range (1,11):
                simulation_folder = f"simulation_analysis/feo/Temperature{temp}_distance{d}_azimuth1_0pi_elevation1_{to_fraction(elevation1)}pi_azimuth2_0pi_elevation2_{to_fraction(elevation2)}pi"
                ...
                # in the 'simulation_analysis/feo' parent folder
